...
def get_args():
    ...
    parser.add_argument('--exp_dir', type=str, default='/Users/liuziang/project/FedSaC/experiments/',
    ...
    parser.add_argument('--datadir', type=str, required=False, default="/Users/liuziang/project/FedSaC/data/", help="Data directory")
    ...
    parser.add_argument('--target_dir', type=str, default="/Users/liuziang/project/FedSaC/", help='Hyper-parameter to avoid concentration')
    # attack
